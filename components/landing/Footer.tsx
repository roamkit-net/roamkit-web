const socialLinks = [
  {
    label: "Twitter",
    href: "https://twitter.com/roamkit",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/roamkit",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  return (
    <footer className="relative border-t border-white/5 px-6 py-8 sm:px-10 lg:px-16">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 sm:flex-row">
        ...
        <p className="text-sm text-slate-500">© 2024 RoamKit. All rights reserved.</p>
      </div>
